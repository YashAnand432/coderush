...
const Page = () => {
  ...
  return (
    <div>
      <AcountNavbar colour={"bg-gradient-to-r from-zinc-800 to-slate-800"} hoverColour={"black"} />
      <div className="p-16">
        <div className="p-8 bg-white shadow mt-24">
          ...
          <div className="mt-20 text-center border-b pb-12">
            ...
            <p className="font-light text-gray-600 mt-3">New Delhi</p>
          ...
          <div className="mt-12 flex flex-col justify-center">
            <p className="text-gray-600 text-center font-light lg:px-16">Made By - Yash Anand 
            <br/>
            eat {`->`} code {`->`} sleep
            </p>
