                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className={`flex flex-wrap w-full mb-20 ${isVisible ? "opacity-100 transition-opacity duration-2000" : "opacity-0 transition-opacity duration-500"}`}>
                        ...
                        <p className="lg:w-2/5 p-4 w-full leading-relaxed text-gray-500">
                            We now support 14 popular coding languages. At our core, Coderush is about developers. Our powerful development tools such as Playground help you test, debug and even write your own projects online.
                        </p>
                    </div>
                    {/* cards */}
            ...
            <section className="text-white body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                        ...
                        <h2 className="text-gray-900 font-medium title-font tracking-wider text-base">Yash Anand</h2>
                        <p className="text-gray-500">Student at KIIT</p>
                    </div>
                </div>
            </section>
        </div>
